$(document).ready(function () {
	...
	// Скроллим до старого положения после отправки формы
	if(formOffset = $.cookie('OFFSET_BEFORE_SEND')){
		setTimeout(function() { $(document).scrollTop(parseInt(formOffset));/*console.log(parseInt(formOffset))*/ },1000);
		//$(document).scrollTop(parseInt(formOffset) + 500);
		$.removeCookie('OFFSET_BEFORE_SEND')
	}
