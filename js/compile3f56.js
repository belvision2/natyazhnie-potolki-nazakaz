...
// расчет ПВХ Дверь балконная
        $tiponkaOptions.find(".ok4_1").click(function () {
            $oknaImg.html('<img src="img/calc/okno/okno-4-1.html" >');
...
//ПВХ Дверь балконная двухстворчатая
        $tiponkaOptions.find(".ok4_2").click(function () {
            $oknaImg.html('<img src="img/calc/okno/okno-4-2.html" >');
...
//ПВХ ОКНО ГЛУХОЕ
        $tiponkaOptions.find(".ok1_1").click(function () {
            $oknaImg.html('<img src="img/calc/okno/okno-1-1.html" >');
...
//ПВХ ОКНО ПОВОРОТНОЕ
        $tiponkaOptions.find(".ok1_2").click(function () {
            $oknaImg.html('<img src="img/calc/okno/okno-1-2.html" >');
...
//ПВХ ОКНО ПОВОРОТНО – ОТКИДНОЕ
        $tiponkaOptions.find(".ok1_3").click(function () {
            $oknaImg.html('<img src="img/calc/okno/okno-1-3.html" >');
...
//ПВХ ОКНО Глухое и ПОВОРОТНОЕ
        $tiponkaOptions.find(".ok2_1").click(function () {
            $oknaImg.html('<img src="img/calc/okno/okno-2-1.html" >');
...
//ПВХ ОКНО Глухое и ПОВОРОТНО – ОТКИДНОЕ
        $tiponkaOptions.find(".ok2_2").click(function () {
            $oknaImg.html('<img src="img/calc/okno/okno-2-2.html" >');
...
//ПВХ ОКНО Поворотное и ПОВОРОТНОЕ – ПОВОРОТНОЕ
        $tiponkaOptions.find(".ok2_3").click(function () {
            $oknaImg.html('<img src="img/calc/okno/okno-2-3.html" >');
...
//ПВХ ОКНО Поворотное и ПОВОРОТНО – ОТКИДНОЕ
        $tiponkaOptions.find(".ok2_4").click(function () {
            $oknaImg.html('<img src="img/calc/okno/okno-2-4.html" >');
...
//ПВХ ОКНО Глухое и ПОВОРОТНОЕ  и глухое
        $tiponkaOptions.find(".ok3_1").click(function () {
            $oknaImg.html('<img src="img/calc/okno/okno-3-1.html" >');
...
//ПВХ ОКНО Глухое и ПОВОРОТНОЕ  и ПОВОРОТНОЕ
        $tiponkaOptions.find(".ok3_2").click(function () {
            $oknaImg.html('<img src="img/calc/okno/okno-3-2.html" >');
...
//ПВХ ОКНО ПОВОРОТНОЕ и Глухое и ПОВОРОТНО – ОТКИДНОЕ
        $tiponkaOptions.find(".ok3_3").click(function () {
            $oknaImg.html('<img src="img/calc/okno/okno-3-3.html" >');
    ...
    FormValidate.prototype = {
        ...
        iCanAddFile: function () {
            ...
            if ($fileInput.length) {
                ...
                $fileInput.change(function () {
                    ...
                    $.ajax({
                        url: '/ajax/saveFileForComagic.php',
                        type: 'POST',
                        data: formData,
                        processData: false,
                        contentType: false,
                        success: function(data) {
                            $('#file_url_eskiz').val(data);
        ...
        comagicGo: function () {
            var $nameField = this.$fields.filter('._name'),
                ...
                email = $('#file_url_eskiz').val() ? $('#file_url_eskiz').val() : '-',
            ...
            setTimeout(function () {
				$.cookie('OFFSET_BEFORE_SEND', $(document).scrollTop(), {path: '/'});
...
(function ($) {
    ...
    var $fancy = $('.js-fancy'),
        fancyOpt = {
            ...
            afterShow: function () {
                $('.fancybox-scrolable').click(function () {
                    //фикс баги apple. Не закрывались формы
                });
            }
        };
    ...
    NotFirstFancyForm.prototype.start = function () {
        ...
        if (host != "plastikovie-okna.ru") {
            this.idTimeout = setTimeout(function () {
                self.goFancy();
                if(self.tss){
                    self.timeout = 60000*30;
                }
            }, this.timeout);
        }
